...
If you added your own wrappers like:

```javascript
function runManualTestFor(date) { ... }
function runCustomSprintTestFor(date, label) { ... }
```

You can run these from the script menu or console without typing parameters repeatedly.
